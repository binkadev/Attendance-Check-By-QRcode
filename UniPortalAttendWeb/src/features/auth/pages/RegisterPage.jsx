...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!agreeTerms) {
      return toast.error('Vui lòng đồng ý với Điều khoản sử dụng');
    }
        ...
        <div className="container mx-auto px-4 lg:px-24 flex justify-between items-center relative z-10">
          ...
          <div className="hidden lg:block w-1/2 pr-12">
            <h2 className="text-4xl font-extrabold text-gray-900 leading-tight mb-4">
              ...
              <span className="text-red-600">Giáo dục thông minh</span>
            </h2>
            <p className="text-gray-600 text-lg mb-8 max-w-md">
              Tạo tài khoản Giảng viên ngay hôm nay để quản lý điểm danh bằng QR Code động. Sinh viên quét mã qua App, tiết kiệm thời gian và nâng cao hiệu quả.
            </p>
            <div className="flex gap-6">
              <div className="flex items-center gap-2 text-gray-700">
                <Zap className="text-orange-500" size={20} />
                <span className="font-medium">Nhanh chóng</span>
              </div>
              <div className="flex items-center gap-2 text-gray-700">
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100 overflow-hidden">
              <div className="p-8">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm text-gray-500">Đăng ký để sử dụng đầy đủ các tính năng</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <label className="flex items-start gap-2 cursor-pointer group mt-2">
                    ...
                    <span className="text-sm text-gray-600 leading-tight">
                      ...
                      <Link to="/terms" target="_blank" className="text-red-600 hover:text-red-700 font-medium transition-colors">Điều khoản dịch vụ</Link>
                      {' '}và{' '}
                      <Link to="/privacy" target="_blank" className="text-red-600 hover:text-red-700 font-medium transition-colors">Chính sách bảo mật</Link>
                    </span>
                  </label>
      ...
      <footer className="py-6 bg-white border-t border-gray-100 shrink-0">
        <div className="container mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-4 text-sm text-gray-500 mb-2">
            <Link to="#" className="hover:text-gray-900 transition-colors">Giới thiệu</Link>
            <span>|</span>
            ...
            <span>|</span>
            <Link to="#" className="hover:text-gray-900 transition-colors">Liên hệ</Link>
          </div>
